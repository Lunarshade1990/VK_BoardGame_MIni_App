...
@Configuration
@EnableEntityViews("com.lunarshade.vkapp.dto.userdao")
@EnableJpaRepositories(
        basePackages = "com.lunarshade.vkapp",
        repositoryFactoryBeanClass = BlazePersistenceRepositoryFactoryBean.class)
public class BlazePersistenceConfiguration {

    private final LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean;

    public BlazePersistenceConfiguration(LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean) {
